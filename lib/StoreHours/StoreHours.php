...
class StoreHours
{
    ...
    public function __construct($hours = array(), $exceptions = array(), $templates = array())
    {
        ...
        // Had to change this because: Error: Unsupported operand types
        // $this->templates += $defaultTemplates;
        // http://stackoverflow.com/a/19712372/2001346
        $this->templates = array_merge((array)$this->templates, $defaultTemplates);
    }
